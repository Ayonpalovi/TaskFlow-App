  ...
  return (
    <Layout allowed={["admin"]}>
      ...
      {detail && (
        ...
        >
          <div
            className="bg-zinc-950 border border-white/10 rounded-md max-w-3xl w-full max-h-[85vh] overflow-y-auto p-6"
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 text-sm mb-4">
              ...
              <div>
                ...
                <span className="font-mono">{detail.deadline}</span>
              </div>

              <div>
                <span className="text-zinc-500">Videos:</span>{" "}
                <span className="font-mono">{detail.num_videos}</span>
              </div>
            ...
            <div className="space-y-2 text-sm bg-zinc-900/50 border border-white/10 rounded-md p-4">
              {[
                ["Goal", detail.brief_goal],
                ["Audience", detail.brief_audience],
                ["Hook", detail.brief_hook],
                ["Body", detail.brief_body],
                ["CTA", detail.brief_cta],
                ["Style", detail.brief_style],
              ].map(([k, v]) => (
                <div key={k}>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-zinc-500">
                          Match {r.skill_match}% · Perf {r.performance_score}% ·
                      ...
                      <button
                        data-testid={`assign-editor-${r.editor.id}`}
                        onClick={() => assign(r.editor.id)}
