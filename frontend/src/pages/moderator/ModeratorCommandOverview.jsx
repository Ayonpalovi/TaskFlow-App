...
const STATUS_LABELS = { available: "available", active: "active", awaiting_admin_approval: "awaiting admin approval", client_review: "client review", revision: "revision", completed: "completed" };
const STATUS_COLORS = { available: "#71717A", active: "#3B82F6", awaiting_admin_approval: "#F59E0B", client_review: "#8B5CF6", revision: "#EF4444", completed: "#10B981" };
...
export default function ModeratorCommandOverview() {
  ...
  const statusData = dashboard.status_breakdown || [];
  const operationsDaily = dashboard.operations_daily || [];
  const trendData = accessAllowed ? (finance.daily || []) : operationsDaily;
